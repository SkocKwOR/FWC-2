...
\end{table}
\\total number of possible outcomes = $\comb{N}{n}$\\
total numbr of favourable outcomes = $\comb{q}{n}$\\
probability = P =$\frac{\comb{q}{n}}{\comb{N}{n}}$ \\
\textbf{a : one ticket}\\
probability = P = $\frac{\comb{9990}{1}}{\comb{10000}{1}}$ = 0.9990\\
\textbf{b : two ticket}\\
probability = P = $\frac{\comb{9990}{2}}{\comb{10000}{2}}$ = 0.9980\\
\textbf{c : 10 ticket}\\
probability = P = $\frac{\comb{9990}{1}}{\comb{10000}{1}}$ = 0.9901
\end{document}
